...
const Blogs = () => {
  return (
    <div className='blogs-section relative'>
      ...
      <div className="simantic-element pt-12 px-5">
        ...
        <h1 className="text-3xl font-mono mt-5">
          Q2.What other service does firebase provide other than Authentication?
        </h1>
        <p className="text-xl text-gray-500 md:pl-10">
        ...
        <h1 className="text-3xl font-mono mt-5">
          Q3.Why are you using firebase? What other options do you have to implement authentication?
          <p className="text-xl text-gray-500 md:pl-10">
            -- - - -- -- -- --
          </p>
        </h1>
