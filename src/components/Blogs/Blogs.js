...
const Blogs = () => {
  return (
    <div className='blogs-section relative pb-10'>
      <h2 className='text-center text-4xl font-mono font-bold py-3'  data-aos="zoom-in">My Blogs</h2>
      <hr data-aos="fade-right" className='w-[200px] mx-auto border-b-2 border-black mb-1' />
      <hr data-aos="fade-left" className='w-[150px] mx-auto border-b-2 border-black mb-1' />
      <hr data-aos="fade-right" className='w-[100px] mx-auto border-b-2 border-black mb-1' />
      <div className="simantic-element pt-12 px-5">
        <h1 data-aos="fade-up" className="text-3xl font-mono">Q1.Difference between Authorization & Authentication?</h1>
        <p data-aos="fade-up" className="text-xl text-gray-500 md:pl-10">
        ...
        <h1 data-aos="fade-up" className="text-3xl font-mono mt-5">
